...
public class TestApi {
    ...
    private static void listUsersById() {

        System.out.println("Listing users by id----------");
        RestTemplate restTemplate = new RestTemplate();
        List<LinkedHashMap<String, Object>> usersMap = restTemplate.getForObject(REST_SERVICE_URI + "/users/1, 2, 3", List.class);
